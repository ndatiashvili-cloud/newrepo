"""
RND - Research & Development Network Monitoring Platform
Modern FastAPI-based Network Management System

Copyright © 2025 RND Team
...
app = FastAPI(
    title="RND - Network Monitoring Platform",
    description="""
## Research & Development Network Monitoring & Management System
...
* OpenAPI Schema: `/openapi.json`
    """,
    version="2.0.0",
    contact={"name": "RND Team", "url": "https://rnd.dev", "email": "info@rnd.dev"},
    license_info={"name": "Proprietary", "url": "https://rnd.dev/license"},
    docs_url="/docs",
    redoc_url="/redoc",
...
from routers import (
    ...
    discovery,
    infrastructure,
    integrations,  # Added integrations router
    metrics,
    monitoring,
    reports,
    settings,
...
app.include_router(integrations.router)  # Added integrations router
