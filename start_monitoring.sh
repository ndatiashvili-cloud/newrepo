#!/bin/bash
# RND - Start Monitoring Stack
# Starts VictoriaMetrics, Redis, and Celery workers

echo "======================================================================"
echo "RND - Monitoring Stack Startup"
echo "======================================================================"
...
if nc -z localhost 6379 2>/dev/null; then
    ...
    echo "✓ Celery beat started (logs: logs/celery_beat.log)"
else
